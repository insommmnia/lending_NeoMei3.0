document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelector(".hero-container").style.transform = "scale(100%)";
});
...
onScrolledTo(document.getElementById('about-us'), function() {
    document.querySelector(".services-box").style.opacity = 1;
    document.querySelector(".services-box").style.transition = "4.7s cubic-bezier(0.645, 0.045, 0.355, 1)";
    if (scrolled_event1 = 1) {
        console.log("Вы доскролили до нужного блока");
...
$(function() {
    $(window).scroll(function() {
        var footer_btm = $(document).scrollTop() + $(window).height() + 300;
        if (mediaQuery.matches) {
            footer_btm = $(document).scrollTop() + $(window).height() + 500;
        }

        if (mediaQuery3.matches) {
            footer_btm = $(document).scrollTop() + $(window).height() + 700;
        }

        if (footer_btm > $(document).height()) {
            document.querySelector(".forma").style.opacity = 1;
            document.querySelector(".forma").style.transition = "0.7s cubic-bezier(0.645, 0.045, 0.355, 1)";
            document.querySelector(".forma").style.transform = "translateY(0%)";
        ...
        var scroll_position = window.innerHeight - 150;
        var scroll_position2 = window.innerHeight + 350;
        var scroll_position3 = window.innerHeight + 750;
        var scroll_position4 = window.innerHeight - 600; // set to whatever you want it to be
        if (y_scroll_pos > scroll_position4) {

            document.querySelector(".bg-fixed").style.top = "30vh";
            document.querySelector(".bg-fixed_back").style.top = "20vh";
            document.querySelector(".hero-container").style.transform = "translateY(-50%)";
            document.querySelector(".hero-container").style.opacity = 0;

        }
        if (y_scroll_pos < scroll_position4) {

            document.querySelector(".bg-fixed").style.top = "60vh";
            document.querySelector(".bg-fixed_back").style.top = "50vh";
            document.querySelector(".hero-container").style.transform = "translateY(0%)";
            document.querySelector(".hero-container").style.opacity = 1;
        }
        if (y_scroll_pos > scroll_position) {
            document.querySelector(".services-box").style.opacity = 1;
            document.querySelector(".services-box").style.transform = "scale(100%)";
            document.querySelector(".description-section").style.opacity = 0;
            document.querySelector(".description-section").style.transform = "scale(90%)";

        }
        if (y_scroll_pos < scroll_position) {
            document.querySelector(".services-box").style.opacity = 0;
            document.querySelector(".services-box").style.transform = "scale(90%)";

        }
        if (y_scroll_pos > scroll_position2) {
            document.querySelector(".services-box").style.opacity = 0;
            document.querySelector(".services-box").style.transform = "scale(90%)";
            document.querySelector(".description-section").style.opacity = 1;
            document.querySelector(".description-section").style.transform = "scale(100%)";

        }
        if (y_scroll_pos > scroll_position3) {
            document.querySelector(".bg-fixed2").style.opacity = 1;
        }
        if (y_scroll_pos < scroll_position3) {


            document.querySelector(".bg-fixed2").style.opacity = 0;
...
function parallaxScroll() {
    var scrolled = $(window).scrollTop();
    $('#parallax-bg').css('top', (70 - (scrolled * .08)) + 'vh');

    $('#parallax-bg2').css('top', (85 - (scrolled * .08)) + 'vh');
...
(function(cp) {
    ...
    **/
    ...
    @param {String} [options.color='rgba(20,28,28,0.8)'] The color emitted by
    ...
    **/
    ...
    cp.Lamp.defaults = {
        ...
        @property color
        @type String
        @default 'rgba(20,28,28,0.8)'
        **/
        color: 'rgba(20,28,28,0.8)',
    ...
    **/
    cp.Lighting.prototype.cast = function(ctxoutput) {
        ...
        ctx.fillStyle = "rgba(20,20,20," + Math.round(50 / n) / 50 + ")"; // Is there any better way?
...
const light = new window.illuminated.Lamp({
    ...
    diffuse: 1,
    color: 'rgba(83,60,130,0.2)',
    radius: 5,
    samples: 0,
});

const mask = new window.illuminated.DarkMask({ lights: [light], color: 'rgba(20,20,20,0.75)' });
